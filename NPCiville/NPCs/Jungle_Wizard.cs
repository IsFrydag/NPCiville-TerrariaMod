...
{
    [AutoloadHead]
    public class Jungle_Wizard : ModNPC
    {
        ...
        public override void AddShops()
        {
            ...
            //npcShop.Add(new Item(ModContent.ItemType<>()) { shopCustomPrice = Item.buyPrice(gold: 5) });
        ...
        {
            NPC.FindFirstNPC(ModContent.NPCType<Jungle_Wizard>());
