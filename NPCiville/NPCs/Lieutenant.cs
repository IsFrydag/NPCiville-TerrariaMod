...
{
    [AutoloadHead]
    public class Lieutenant : ModNPC
    {
        ...
        public override void AddShops()
        {
            ...
            //npcShop.Add(new Item(ModContent.ItemType<Spawner1>()) { shopCustomPrice = Item.buyPrice(gold: 5) });
        ...
        {
            NPC.FindFirstNPC(ModContent.NPCType<Lieutenant>());
